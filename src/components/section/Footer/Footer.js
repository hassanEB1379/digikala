    ...
    <footer className="bg-white pt-12 pb-5">
      <Container maxWidth="1366px">
        <div className="flex justify-between">
          ...
          <Button>برگشت به بالا</Button>
        </div>

        <p className="flex gap-8 text-lg text-gray-500">
        ...
        <div className="flex justify-between">
          <ul>
            ...
            <li className="mt-6 text-lg text-gray-500">اتاق خبر دیجی کالا</li>
            <li className="mt-6 text-lg text-gray-500">فروش در دیجی کالا</li>
            <li className="mt-6 text-lg text-gray-500">فرصت های شغلی</li>
            <li className="mt-6 text-lg text-gray-500">تماس با دیجی کالا</li>
            <li className="mt-6 text-lg text-gray-500">درباره دیجی کالا</li>
          </ul>
          ...
          <ul>
            <p className="text-xl font-medium">راهنمای خرید از دیجی کالا</p>
            <li className="mt-6 text-lg text-gray-500">نحوه ثبت سفارش</li>
            <li className="mt-6 text-lg text-gray-500">رویه ارسال سفرش</li>
            <li className="mt-6 text-lg text-gray-500">شیوه های پرداخت</li>
          </ul>
        ...
        <div className="bg-darkBlue my-12 p-5 rounded-xl flex justify-between items-center">
          <div className="flex items-center gap-6">
            <img src="/static/images/digikala-icon.svg" alt="digikala-icon" />
          ...
          <div className="flex gap-4">
            ...
            <a
              href="/"
              className="w-14 h-14 bg-white flex items-center justify-center rounded-md"
            >
              <FiMoreHorizontal />
            </a>
          </div>
        ...
        <div className="w-2/3">
          ...
          <p className="leading-loose text-justify text-gray-400 mt-5">
            ...
            <span
              ...
              hidden={showMore}
            >
              حتی زمانی که بین خرید کالاها برای شخصی مردد هستید می‌توانید با
              خرید
              <a target="_blank" href="/">
                کارت هدیه دیجی کالا
              </a>
              ، انتخاب را به سایرین بسپارید. این فروشگاه مثل یک ویترین پر زرق و
              برق است که با انواع و اقسام محصولاتی نظیر
              <a target="_blank" href="/">
                گوشی موبایل سامسونگ
              </a>
              ،
              ...
              و همچنین محصولاتی که هر فرد در زندگی شخصی، تحصیلی و کاری خود به
              آنها احتیاج پیدا می‌کند، چیده شده است. اینجا مرجع متنوع‌ترین
              کالاهای مصرفی از
              <a target="_blank" href="/">
              ...
              می‌باشد تا هر فرد بتواند مطابق با سلیقه شخصی خود، خانه رویاهایش را
              بسازد. حتی می‌توانید از مشهورترین برندهای داخلی و خارجی انواع
              <a target="_blank" href="/">
                مدل مانتو جدید
              </a>
              ،
              ...
              را به صورت آنلاین با کمک راهنمای سایز خریداری کنید. این فروشگاه
              اینترنتی حتی برای سرگرمی کودکان هم خرید محصولاتی مانند
              <a target="_blank" href="/">
                عروسک
              </a>
              ،
              ...
              را فراهم کرده است. همچنین با سر زدن به محصولات آرایشی و بهداشتی
              زنانه و مردانه مانند
              <a target="_blank" href="/">
                عطر و ادکلن دیور
              </a>
              ،
              ...
              می‌توانید تجربه‌ای جدید از خرید آنلاین کسب کنید. شما می توانید
              کلیه نیازهای خود را تنها با چند کلیک سفارش داده و در کمترین زمان
